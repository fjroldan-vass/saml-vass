...
public class SamlSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public MetadataGenerator metadataGenerator() {
        ...
        metadataGenerator.setEntityId("samldemoei");
        metadataGenerator.setEntityBaseURL("http://localhost:8443");
    ...
    public SAMLContextProviderImpl contextProvider() {
        ...
        samlContextProviderLB.setServerPort(8443);
    ...
    public ExtendedMetadataDelegate idpMetadata()
        ...
        ResourceBackedMetadataProvider resourceBackedMetadataProvider =
                new ResourceBackedMetadataProvider(backgroundTaskTimer, new ClasspathResource("/metadata-provider.xml"));
